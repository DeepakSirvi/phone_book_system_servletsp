        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
                ...
                <span class="menu-title"><i class="fa fa-dashboard" style="font-size:20px;"></i>&nbsp;Admin Dashboard</span>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic1">
                <ul class="nav flex-column sub-menu">
                  ...
                  { 
                  %>
                  <li class="nav-item"> <a class="nav-link" href="./PhoneBookController?Action=GETGROUP&gid=<%=group.getgId() %>" ><%=group.getgName() %></a>
                  </li>                 
                    <% 
                    }
                   %>            
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic2">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="pages/ui-features/Determine.html">Determine Eligibility</a></li>
          ...
          <% } %>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="pages/ui-features/createaccount.html">Create Account</a></li>
                  <li class="nav-item"> <a class="nav-link" href="pages/ui-features/viewacc.html">View Account</a></li>
                  <li class="nav-item"> <a class="nav-link" href="pages/ui-features/createplan.html">Create Plan</a></li>
                  <li class="nav-item"> <a class="nav-link" href="pages/ui-features/viewplan.html">View Plan</a></li>
