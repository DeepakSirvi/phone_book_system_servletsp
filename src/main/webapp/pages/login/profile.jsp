                      ...
                      <div class="col-12 mx-auto">
                        <div class="auth-form-light text-left p-5">
                          ...
                          <form class="pt-3" action="./PhoneBookController">
                              <div class="row mt-2">
                                  <div class="col-md-6"><label class="labels">Name</label><input type="text" class="form-control" placeholder="first name" name="uname" value=<%=user.getuName()%>  required></div>
                                  <div class="col-md-6"><label class="labels">Address</label><input type="text" class="form-control" name="uaddress" value=<%=user.getuAddress()%> placeholder="surname"  required></div>
                              </div>
                              <div class="row mt-2">
                                <div class="col-md-6"><label class="labels">Mobile Number</label><input type="number" name="umobile" class="form-control" placeholder="Mobile Number" value=<%=user.getuMobile() %>  required></div>
                                <div class="col-md-6"><label class="labels">Gmail</label><input type="gmail" name="uemail" class="form-control" value=<%=user.getuEmail() %> placeholder="Gmail"  required></div>
