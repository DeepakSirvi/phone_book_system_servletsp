...
.groupmenu
{
  ...
  <%ArrayList<Contact> conlist=(ArrayList)request.getAttribute("conlist"); %>
    <%ArrayList<GroupDivision> glist=(ArrayList<GroupDivision>)request.getAttribute("glist"); %> 
    <%GroupDivision groupid=(GroupDivision)request.getAttribute("group"); %>
          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title"><%=groupid.getgName() %></h4>
                 </div>
                 <div class="groupmenu">

					      <%
					      if(groupid.getgFav()==0)
					      {%>
					    	 <a href="./PhoneBookController?Action=GROUPFAVOURITE&gfav=<%=groupid.getgFav()%>&gid=<%=groupid.getgId()%>"><img class="favimage" src="./pages/ui-features/unfav.png" alt="notfav"></a>
					    	 <%}
					      else
					      { %>
					    	  <a href="./PhoneBookController?Action=GROUPFAVOURITE&gfav=<%=groupid.getgFav()%>&gid=<%=groupid.getgId()%>"><img class="favimage" src="./pages/ui-features/fav.jpeg"  alt="not"></a>
					     	  <%}
					     
					    %>
					    
                    <a href="./PhoneBookController?Action=CONADDGROUP&gid=<%=groupid.getgId()%>"><img class="favimage" src="./pages/ui-features/plus.png"></a>
                    <a href="./PhoneBookController?Action=REMOVEGROUP&gid=<%=groupid.getgId()%>"><img class="favimage" src="./pages/ui-features/delete.png"></a>
                     <a href="./PhoneBookController?Action=EDITGROUP&gid=<%=groupid.getgId()%>">Update</a>
                </div>
               </div>
              </div>
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <table id="" class="display hover" style="width:100%;height:220px;">
                      <thead>
                          <tr>
                              <th>Full Name</th>
                              <th>Email ID</th>
  ...
  for (Contact item : conlist) { %>
    ...
    <tr>
      <td><%=item.getConName()%></td>
      <td><%=item.getConEmail()%></td>
      <td><%=item.getConMobile()%></td>
      <td><%=item.getConAddress()%></td>
      <td><a href="./PhoneBookController?Action=REMOVEFROMGROUP&conid=<%=item.getConId()%>&gid=<%=groupid.getgId()%>">Remove</a></td>
     <%--  <td><a href="./PhoneBookController?Action=TOEDITCONTACT&conid=<%=item.getConId()%>">Edit</a>/<a onclick="return confirm('Are You Sure?')" href="./PhoneBookController?Action=DELETECONTACT&conid=<%=item.getConId()%>">Delete</a>
       <td><%
      if(item.getConIsFav()==0)
      {
    	 %>
    	 <a href="./PhoneBookController?Action=FAVOURITE&isfav=<%=item.getConIsFav()%>&conid=<%=item.getConId()%>"><img class="favimage" src="./pages/ui-features/unfav.png" alt="notfav"></a>
      ...
      {
    	  %>
    	  <a href="./PhoneBookController?Action=FAVOURITE&isfav=<%=item.getConIsFav()%>&conid=<%=item.getConId()%>"><img class="favimage" src="./pages/ui-features/fav.jpeg"  alt="not"></a>
