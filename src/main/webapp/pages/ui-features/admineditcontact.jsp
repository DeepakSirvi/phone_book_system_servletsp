                    ...
                    <form action="./PhoneBookController">
                      <div class="form-group">
                        ...
                        <div class="row">
                          ...
                          <div class="col">
                            ...
                            <input type="email" class="form-control" id="name" placeholder="johndoe@gmail.com" name="conemail" value="<%=contact.getConEmail()%>">
                           <br>
                      ...
                      <div class="row">
                        <div class="col">
                          ...
                          <input type="number" class="form-control" id="phone" placeholder="1234567890" name="conmobile" value="<%=contact.getConMobile()%>">
...
<!--                           <form action="/action_page.php">
                      ...
                      <input type="hidden" name="uidbyadmin" value="<%=contact.getuId()%>">
                      <input type="hidden" name ="Action" value="UPDATECONTACTADMIN">
