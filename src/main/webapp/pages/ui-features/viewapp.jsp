...
.navbar .navbar-menu-wrapper .search-field .input-group input {
  ...
  for (Contact item : conlist) { %>
    ...
    <tr>
      ...
      <td>
      <a href="./PhoneBookController?Action=TOEDITCONTACT&conid=<%=item.getConId()%>">Edit</a>/<a onclick="return confirm('Are You Sure?')" href="./PhoneBookController?Action=DELETECONTACT&conid=<%=item.getConId()%>">Delete</a>
       <td><%
