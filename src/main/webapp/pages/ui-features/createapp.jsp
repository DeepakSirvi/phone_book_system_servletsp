                    ...
                    <form action="./PhoneBookController">
                      <div class="form-group">
                        ...
                        <div class="row">
                          <div class="col">
                            ...
                            <input type="text" class="form-control" id="name" placeholder="John Doe"  name="conname" value="" required>
                          </div>
                          <div class="col">
                            <label for="name">Email ID</label>
                            <input type="email" class="form-control" id="name" placeholder="johndoe@gmail.com" name="conemail" value="">
                           <br>
                      ...
                      <div class="row">
                        <div class="col">
                          ...
                          <input type="number" class="form-control" id="phone" placeholder="1234567890" name="conmobile" value="" required>
                        </div>
                         <div class="col">
                          <label for="address">Address</label>
                          <input type="text" class="form-control" id="address" placeholder="India" name="conaddress" value="">
                        </div>
